...
imageTotalHistogram = hist(imageTable$NumLogins,main="Total Login Attempts Per User: Image21",xlab="# of Attempts", breaks=20, col="purple")
textTotalHistogram = hist(textTable$NumLogins,main="Total Login Attempts: text21",xlab="# of Attempts", breaks=20, col="purple")
imageSuccessfulHistogram = hist(imageTable$NumSuccessful,main="Successful Login Attempts: Image21",xlab="# of Attempts", breaks=20, col="light blue")
...
imageFailedHistogram = hist(imageTable$NumFailed,main="Failed Login Attempts: Image21", xlab="# of Attempts",breaks=20, col="red")
...
imageSuccessTimeHistogram = hist(imageTable$SuccessTime,main="Frequency of Average Successful Login Time: Image21",xlab="Time (s)", breaks=20, col="light blue")      
...
imageFailedTimeHistogram = hist(imageTable$FailedTime,main="Frequency of Average Failed Login Time: Image21",xlab="Time (s)", breaks=20, col="red")
