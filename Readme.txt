...
Files:
	...
	Part 2: 
	        * Folder: Images - Images of created data graphs
		* data.csv - copy of file from Part 1, used in R script.
		* formatData.js - code used to format PassAttempts.csv
		* index.html - UI used to create PassAttempts.csv
		* parsed_data.csv - generated from formatData.js (Part 2)
		...
		* 3008part2graphscript.R - R script for graphs for successful time and other stats.
